...
import org.apache.commons.numbers.examples.jmh.core.generated.LinearCombinationPerformance_Calculator_jmhType;
import org.apache.commons.numbers.examples.jmh.core.generated.LinearCombinationPerformance_LengthFactors_jmhType;
import org.apache.commons.numbers.examples.jmh.core.generated.LinearCombinationPerformance_jmhType;
public final class LinearCombinationPerformance_nD_jmhTest {
    ...
    public static void nD_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, LinearCombinationPerformance_LengthFactors_jmhType l_lengthfactors1_G, LinearCombinationPerformance_Calculator_jmhType l_calculator2_G, LinearCombinationPerformance_jmhType l_linearcombinationperformance0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult nD_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            nD_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_lengthfactors1_G, l_calculator2_G, l_linearcombinationperformance0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "nD", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void nD_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, LinearCombinationPerformance_LengthFactors_jmhType l_lengthfactors1_G, LinearCombinationPerformance_Calculator_jmhType l_calculator2_G, LinearCombinationPerformance_jmhType l_linearcombinationperformance0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult nD_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            nD_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_lengthfactors1_G, l_calculator2_G, l_linearcombinationperformance0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "nD", buffer, benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void nD_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, LinearCombinationPerformance_LengthFactors_jmhType l_lengthfactors1_G, LinearCombinationPerformance_Calculator_jmhType l_calculator2_G, LinearCombinationPerformance_jmhType l_linearcombinationperformance0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult nD_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            nD_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_lengthfactors1_G, l_calculator2_G, l_linearcombinationperformance0_G);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "nD", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void nD_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, LinearCombinationPerformance_LengthFactors_jmhType l_lengthfactors1_G, LinearCombinationPerformance_Calculator_jmhType l_calculator2_G, LinearCombinationPerformance_jmhType l_linearcombinationperformance0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile LinearCombinationPerformance_LengthFactors_jmhType f_lengthfactors1_G;
    
    LinearCombinationPerformance_LengthFactors_jmhType _jmh_tryInit_f_lengthfactors1_G(InfraControl control) throws Throwable {
        LinearCombinationPerformance_LengthFactors_jmhType val = f_lengthfactors1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            try {
            if (control.isFailing) throw new FailureAssistException();
            val = f_lengthfactors1_G;
            if (val != null) {
                return val;
            }
            val = new LinearCombinationPerformance_LengthFactors_jmhType();
            Field f;
            ...
            f = org.apache.commons.numbers.examples.jmh.core.LinearCombinationPerformance.LengthFactors.class.getDeclaredField("length");
            f.setAccessible(true);
